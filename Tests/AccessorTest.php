...
class ExtendingObj extends TestObj
{
    public $myProp = true;
}
...
class AccessorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testStdClass()
    {
        ...
        $this->object = new Accessor($obj);
        $this->assertEquals('pwet', $this->object->get('coucou'));
        $this->assertFalse($this->object->get('nonExistant'));
        $this->object->set('coucou', 'changed');
        $this->assertEquals('changed', $this->object->get('coucou'));
    }
